...
<body onload = "loadDataPowerSwitch()" class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active"><a href="power_switch.php"><i class="fa fa-link"></i> <span>Power Switch</span></a></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">User Power Switch Data Table</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
    ...
    while($row = $result->fetch_assoc()){
      ?>
      <!-- Update Modal Start-->
      <div id="update_Power_Switch_Modal<?php echo $row['account_id'];?>" class="modal fade" role="dialog">
        <div class="modal-dialog">
          ...
          <div class="modal-content" >
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Update Power Switch status</b></h4>
            </div>
            <div class="modal-body">
              <form id ="update_Power_Switch_form<?php echo $row['account_id'];?>" enctype="multipart/form-data">
                ...
                <label style = "color:#000;">Switch Status:</label>
                <input type = "text" class= "form-control" name = "status" value ="<?php echo $row['status'];?> " readonly />
                <label style = "color:#000;">Deactivation Status:</label>
                <select class="form-control" name="cut" >
                  <option><?php echo $row['Cut'];?></option>
...
<script>
$('#add_Power_Switch_form').on('submit',(function(e) {
  e.preventDefault();
  var formData = new FormData(this);

  $.ajax({
    type:'POST',
    url: "dist/api/add_power_switch.php",
    data:formData,
    cache:false,
    contentType: false,
    processData: false,
...
$('#update_Power_Switch_form<?php echo $row['account_id'];?>').on('submit',(function(e) {
  e.preventDefault();
  var formData = new FormData(this);

  $.ajax({
    type:'POST',
    url: "dist/api/update_power_switch.php",
    data:formData,
    cache:false,
    contentType: false,
    processData: false,
