...
<head>
	...
	<title>S C E E M S - Bill Log</title>
...
<body id="banner">
	...
	<div class="wrappper">
		...
		<section class="container" style =  "padding-top: 50px; padding-bottom:150px">
			...
			<center><h4 style = "color:#fff">BILL LOG</h4></center>

        <table class = "table animated fadeInDown delay-1s">
        <thead style = "background-color:#195b71;" >
        <tr>

        <td style = "color:#fff"><center>Month</center></td>
        <td style = "color:#fff">kW/h Consumed</td>
        <td style = "color:#fff">Bill</td>
  >
        </tr>
        </thead>
        <?php
include "connection.php";
$sql = "SELECT * FROM bill_cycle WHERE account_id = $account_id";
...
<tbody id='tbodie'>
<tr >
<td style = "color:#fff; font-size:12px;"><?php echo $row['month'], ", " , $row['year']?></td>
<td style = "color:#fff; font-size:12px;"><?php echo round($tblConsume,2), " kW/h"?></td>
<td style = "color:#fff; font-size:12px;"><?php echo "₱" , round($row['total_bill'],2)?></td>
...
<?php }?>
        <table>
					<center><button type="button" class="btn btn-primary btn-round k" onclick="goBack()">BACK</button></center>
				</section>
			</section>
